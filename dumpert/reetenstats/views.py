...
def importview(request):
    # with open('C:/Users/mzond/OneDrive/Bureaublad/DEV/DumpertReetenStats/data/shows.csv') as csv_file:
    ...
    # with open('C:/Users/mzond/OneDrive/Bureaublad/DEV/DumpertReetenStats/data/videos.csv', encoding="utf8") as csv_file:
    #     csv_reader = csv.reader(csv_file, delimiter=';')
    #     line_count = 0
    #     for row in csv_reader:
    #         print(row[1])
    ...
    # with open('C:/Users/mzond/OneDrive/Bureaublad/DEV/DumpertReetenStats/data/reeting-types.csv', encoding="utf8") as csv_file:
    #     csv_reader = csv.reader(csv_file, delimiter=';')
    #     line_count = 0
    #     for row in csv_reader:
    #         print(row[1])
    ...
    # with open('C:/Users/mzond/OneDrive/Bureaublad/DEV/DumpertReetenStats/data/gasten.csv', encoding="utf8") as csv_file:
    #     csv_reader = csv.reader(csv_file, delimiter=';')
    #     for row in csv_reader:
    ...
    with open('C:/Users/mzond/OneDrive/Bureaublad/DEV/DumpertReetenStats/data/reetings.csv', encoding="utf8") as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=';')
        for row in csv_reader:
